            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    <v-list-item
                        class="px-2"
                        key="restaurants"
                        to="/improvedRestaurantSearches/restaurants"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="orders"
                        to="/simplifiedOrderProcesses/orders"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        ...
                        to="/enhancedAddressInputs/deliveryAddresses"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '맛집', 
                description: '맛집에 대한 정보를 담고 있는 집합체', 
                key: 'restaurants', 
                route: '/improvedRestaurantSearches/restaurants',
                ImageUrl: '',
            },
            { 
                title: '주문', 
                description: '음식을 주문하는 동작', 
                key: 'orders', 
                route: '/simplifiedOrderProcesses/orders',
                ImageUrl: '',
            },
            { 
                title: '배달 주소', 
                description: '배달 받을 주소 정보', 
                key: 'deliveryAddresses', 
                route: '/enhancedAddressInputs/deliveryAddresses',
                ImageUrl: '',
            },
